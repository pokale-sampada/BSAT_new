		...
		<div class="col-lg-6">
			<div class="page-header-breadcrumb" style="padding-right: 1em;">
				<ul class="breadcrumb-title">
					...
					<li class="breadcrumb-item"><a href="menugroupgrid">Master Entry</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<h6 class="panel-title" style="color: ;">Product
Master Table Entry</h6>
<div></div>
</header>
...
<h6 class="panel-title">Transaction Master Table
Entry</h6>
<div></div>
</header>
<div class="panel-body">
...
<div class="col-md-3">
<input type="button" class="btn btn-primary mb-md" id="prd"
value="Download Template" onclick="downloadTransactionMaster()">
</div>
<br>
<div class="col-md-3">
