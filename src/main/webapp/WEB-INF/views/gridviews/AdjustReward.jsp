                                            ...
                                            <div class="page-header-breadcrumb" style="padding-right: 1em;">
                                                <ul class="breadcrumb-title">
                                                   ...
                                                   <!--  <li class="breadcrumb-item"><a href="">Report</a>
                                                    ...
                                                    <li class="breadcrumb-item"><a href="adjustreward">Adjust Reward</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
//alert(scheme_name);
				...
				$(window).load(function(){
					...
					var scheme_name=url_param('scheme_name');
...
// 	 					    	$('<option>').val("").text("--Select--").appendTo(select);
					...
					$.ajax({
					    url: '${pageContext.request.contextPath}/getschemeter',	
					    success: function(data) {				        	
...
function blur_fn(count){
	
	//alert("the count is "+r);
...
$('.adjustpoints_old').keyup(function(){	
			 
		 	
			 alert("adjustment hitt");
			var sum = 0;			 
			var count = $('.adjustpoints').index(this);
			var adjustments = $('#adjustments'+count).val();
        	var adjustment_reason = $('#adjustment_reason'+count).val();
