                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline" style="padding-left: 1em;">
                                                    <h4 style="color: white;">Payout Report</h4>
                                            ...
                                            <div class="page-header-breadcrumb" style="padding-right: 1em;">
                                                <ul class="breadcrumb-title">
                                                   ...
                                                   <!--  <li class="breadcrumb-item"><a href="#!">Report</a>
                                                    ...
                                                    <li class="breadcrumb-item"><a href="payout_report">Payout Report</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
	...
	<div class="card">
		...
		<div class="card-block">
			...
			<div class="form-group row">
				<div class="col-sm-2">
					<label class="block" style="margin-left: 38px;" for="inputSuccess">Scheme Name : </label>
				</div>
				<div class="col-sm-3">
					<select class="form-control form-control-sm " style="margin-left: 10px;" name="scheme_name"
				...
				<div class="col-md-2">
					<label class="block" style="margin-left: 12px;" for="inputSuccess">Distributors Name :
					</label>
				</div>
				<div class="col-md-3">
					<select class="form-control form-control-sm " style="margin-left: 11px;" name="depot_name"
    ...
    display: block;">
						<thead>
							<tr>
								...
								<th class="center" width="15%">Reward_Adjustments</th>
								<th class="center" width="15%">Reward_Adjustments_Reason</th>
							</tr>
						</thead>
						<tbody style="">
							<%
							...
							<c:forEach var="info" items="${Info_grid}" varStatus="status">
								...
								<tr>
									...
									<td bgcolor="<c:out value='${reward_color}'/>">${info.adjustments}<input
										...
										style="width: 100%" value="${info.adjustments}" /></td>
									<td bgcolor="<c:out value='${reward_color}'/>">${info.adjustment_reason}<input
										type="hidden" id="adjustment_reason<%=j%>" name="adjustment_reason"
										style="width: 100%" value="${info.adjustment_reason}" /></td>
								</tr>
								<%
									j = j + 1;
								%>
...
$.ajax({
			...
			url : '${pageContext.request.contextPath}/getschschemename_payout',
...
<script>
	function myFunction2() {
		...
		var scheme_name = $('#scheme_name').val();
/* old code
		window.location.href = "callschoparest_webservice1?depot=" + depot_name
				+ "&scheme_id=" + scheme_name + "&bill_to_id="; */
		
		
		window.location.href = "payout_report_grid?depot=" + depot_name
		+ "&scheme_id=" + scheme_name + "&bill_to_id=";
		//$("#show_details").show();
	}
</script>
