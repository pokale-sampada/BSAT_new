...
<form action="updateoutput_depo" ModelAttribute="Bpil_Opa_Rw_Analysis_Rw"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline" style="padding-left: 1em;">
                                                    <h4 style="color: white;">Adjust Reward Processing</h4>
						...
						<c:forEach var="info" items="${Info_grid}" varStatus="status">
							...
							<tr>
								...
								<td bgcolor="<c:out value='${reward_color}'/>"><input
									...
									onblur="blur_fn(<%=j%>)"   pattern="[0-9]{1,15}" /></td>
								<td bgcolor="<c:out value='${reward_color}'/>"><input
	...
	<div class="form-group">
		<div class="col-md-12" style="text-align: center;">
			<input type="hidden" name="action" id="action" value="" /> <input
				...
				name="gen_report" value="Save" onclick="submitform()"></input>  
...
<script>
				$(window).load(function(){
					 ...
					 */
						...
						$.ajax({
						    url: '${pageContext.request.contextPath}/getadjustschemedepo',	
						    success: function(data) {				        	
...
// 	 					           		}
	 					           	...
	 					           	if(value.dlr_bill_to == "${dlr_ac_name}"){
...
function searchinfo() {
	...
	window.location.href="adjust_reward_depo?scheme_name="+scheme_name+"&depot_code="+depot_code+"&dealer_name="+dealer_name+"&bill_to_id="+bill_to_id;
