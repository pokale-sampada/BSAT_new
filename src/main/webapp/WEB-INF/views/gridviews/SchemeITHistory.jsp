			...
			<div class="dt-responsive table-responsive">
				<table id="header-footer-fix"
					...
					<tbody>
						...
						int j = 1;
					%>
					<c:forEach var="viewprfinfo" items="${historydata}" varStatus="status">
						<tr>
							<td class="text-center"><%=j%></td>
							<td><a
								href="schemedetails?scheme_id=${viewprfinfo.scheme_id}">${viewprfinfo.scheme_name}</a>
							</td>
