...
<section role="main" class="content-body">
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Sub Menu Header</span></li>
			</ol>
	...
	<section class="panel">
		<header class="panel-heading">
			...
			<h2 class="panel-title">Sub Menu Header
			...
			<table class="table table-striped table-bordered table-hover"
				...
				<thead>
					<tr>
						...
						<th class="center">Sub Menu Name</th>
				...
				<tbody>
					<% int j=1; %>
					<c:forEach var="menu_line" items="${menu_line_list}"
						varStatus="status">
						<tr>
							<td class="center"><a
								href="updatemenuheaderline?menu_header_id=${menu_line.menu_line_id}"><%=j%></a></td>
							<td class="center">${menu_line.line_name}</td>
							<td class="center">${menu_line.line_start_date}</td>
							<td class="center">${menu_line.line_end_date}</td>
							<td class="center">${menu_line.active}</td>
						</tr>
						<% j=j+1; %>
					</c:forEach>
