	...
	<div class="card">
		...
		<div class="card-block">
			...
			<div class="form-group row">
				<div class="col-sm-2">
					<label class="block " for="inputSuccess">Scheme Name : <span class="required">*</span></label>
				</div>
				<div class="col-sm-3">
				...
				<div class="col-md-2">
					<label class="block" for="inputSuccess">Distributors Name : <span class="required">*</span>
					</label>
				</div>
				<div class="col-md-3">
