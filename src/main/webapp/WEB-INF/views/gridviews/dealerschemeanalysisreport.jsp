                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline" style="padding-left: 1em;">
                                                    <h4 style="color: white;">Dealer Scheme Analysis</h4>
                                            ...
                                            <div class="page-header-breadcrumb" style="padding-right: 1em;">
                                                <ul class="breadcrumb-title">
                                                   ...
                                                   <!--  <li class="breadcrumb-item"><a href="#!">Report</a>
                                                    ...
                                                    <li class="breadcrumb-item"><a href="schemeanalysis">Dealer Scheme Analysis</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
	...
	<div class="card">
		...
		<div class="card-block">
			...
			<div class="form-group row">
				<div class="col-sm-2" style="margin-left: 34px;">
	...
	$(window)
			.load(
					function() {
						$
								.ajax({
									url : '${pageContext.request.contextPath}/getschemenamedealer',
...
<script type="text/javascript">
	...
	/* 	window.location.href = "loaddepooutputdata?deptnm=" + depot_name
		...
		window.location.href = "callschoparest_webservice1_new_dealer?depot=" + depot_name
	...
	function myFunction4() {
		...
		window.location.href = "downloadloadoutputdata_dealer?schnm=" + scheme_name + "";
		//$("#show_details").show();
	...
	function myFunction5(){
		...
		window.location.href = "dashboard_report_dealer?schnm=" + scheme_name + "";
	}
</script>
<style>
table {
