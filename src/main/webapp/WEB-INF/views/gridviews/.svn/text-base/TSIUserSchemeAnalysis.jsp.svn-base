			...
			<div class="col-md-12">
				...
				<div class="col-md-3">
					<select class="form-control input-sm mb-md populate" name="depot_name"
						data-plugin-selectTwo id="depot_name">
						<option>--Select--</option>
					</select>
				</div>
				<div class="col-md-1"></div>
				...
				<table class="table table-striped table-bordered table-hover" id=""
					...
					<thead>
						<tr>
							...
							<th class="center" style="width: 30%">Document Type</th>
							<th class="center" style="width: 30%">Document Title</th>
							<th class="center" style="width: 10%">Reference Number</th>
							<th class="center" style="width: 10%">Upload Date</th>
							<th class="center" style="width: 15%">Download File</th>
						<tr>
					</thead>
					...
					<tbody>
						...
						<c:forEach var="grp_reg" items="${doc_list}" varStatus="status">
							...
							<tr>
								<td><center>
										<%=i%>
										<input type="hidden" value="${grp_reg.scheme_doc_id}"
											id="scheme_doc_id<%=i%>" name="scheme_doc_id" />
									</center></td>

								<td>
									<center>
										<input type="text" class="lovdata" id="doc_type<%=i%>"
								...
								<td><center>
										<input type="text" id="doc_title<%=i%>" name="doc_title"
											value="${grp_reg.doc_title}" style="width: 100%;" readonly />
									</center></td>

								<td><center>
										<input type="text" id="doc_srl_no<%=i%>" name="doc_srl_no"
											value="${JSON.scheme_srl_no}" style="width: 100%;" readonly />
									</center></td>
								<td><center>
										<input type="text" id="doc_upload_date<%=i%>"
...
<script>
	$(window)
			.load(
					function() {
						$.ajax({
//						     url: '${pageContext.request.contextPath}/gettsischemename1',
						    url: '${pageContext.request.contextPath}/gettsischschemename',
...
//						     url: '${pageContext.request.contextPath}/getschemedepot',
						    url: '${pageContext.request.contextPath}/gettsischemedepotdetails',
...
<script type="text/javascript">
    ...
    window.location.href = "tsiloadoutputdata?deptnm="+depot_name+"&schnm="+scheme_name+"";
