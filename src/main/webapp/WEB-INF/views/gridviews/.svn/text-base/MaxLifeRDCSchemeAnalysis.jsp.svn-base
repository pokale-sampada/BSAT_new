	...
	<form action="updateoutput" method="post" id="Saveform">
			...
			<div class="col-md-12">
				...
				<div class="col-md-3">
					<select class="form-control input-sm mb-md populate"
						data-plugin-selectTwo name="maxlife_scheme_name" id="maxlife_scheme_name"
						required="required">
						<option>--Select--</option>
						<option value="rdc">Max Life RDC Scheme</option>
					</select>
				</div>
				<div class="col-md-1"></div>
				<div class="col-md-2">
					<label class="control-label" for="inputSuccess">Month
						: </label>
				</div>
				<div class="col-md-3">
					<select class="form-control input-sm mb-md" name="month"
						id="month" required="required">
						<option>--Select--</option>
						<option>April</option>
						<option>May</option>
						<option>June</option>
		...
		<section class="panel">
			<header class="panel-heading">
				...
				<h2 class="panel-title">Scheme Analysis</h2>
			...
			<div class="panel-body">
				<table class="table table-bordered table-striped"
					...
					<thead>
						<tr>
							<th class="center" style="min-width:80px;">SR. No</th>
							<th class="center" style="min-width:150px;">ADM ID</th>
							<th class="center" style="min-width:150px;">Agent ID</th>
							<th class="center" style="min-width:150px;">Agent Status</th>
							<th class="center" style="min-width:250px;">ITD Vinatge</th>
							<th class="center" style="min-width:250px;">YTD Vintage</th>
							<th class="center" style="min-width:250px;">MTD Target</th>
							<th class="center" style="min-width:250px;">YTD Target</th>
							<th class="center" style="min-width:250px;">MTD Actual</th>
							<th class="center" style="min-width:250px;">YTD Actual</th>
							<th class="center" style="min-width:250px;">Proactivity Status</th>
							<th class="center" style="min-width:250px;">Multiplying Factor</th>
							<th class="center" style="min-width:150px;">Gross Payout</th>
							<th class="center" style="min-width:250px;">Already Paid Till Now</th>
							<th class="center" style="min-width:250px;">Net Payout</th>
					...
					<tbody>
						...
						<c:forEach var="info" items="${Info_grid}" varStatus="status">
							<tr>
								...
								<td>${info.agent_itd_vintage}</td>
								<td>${info.agent_ytd_vintage}</td>
								<td>${info.agent_mtd_target}</td>
								<td>${info.agent_ytd_target}</td>
								<td>${info.agent_mtd_actual}</td>
								<td>${info.agent_ytd_actual}</td>
								<td>${info.proactivity_status}</td>
								<td>${info.multiplying_factor}</td>
								<td>${info.gross_payout}</td>
								<td>${info.agent_already_paid}</td>
								<td>${info.net_payout}</td>
							</tr>
							<%
								j = j + 1;
							%>
...
// 		var scheme_name = $('#scheme_name').val();
			...
			window.location.href = "downloadMxLfRDCSchAnReportSoap";
...
// 		var scheme_name = $('#scheme_name').val();
			...
			window.location.href = "showMxLfRDCSchAnReportSoap?month="+month;
