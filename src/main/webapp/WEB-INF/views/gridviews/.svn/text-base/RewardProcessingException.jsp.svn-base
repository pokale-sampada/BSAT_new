...
<section role="main" class="content-body">
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Reward Processing Exception</span></li>
			</ol>
	...
	<section class="panel">
		<header class="panel-heading">
			...
			<h2 class="panel-title">Reward Processing Exception</h2>
		</header>
		<div class="panel-body">
			<table class="table table-bordered table-striped" id="datatable-editable"
				...
				<tbody>
											...
											<c:forEach var="viewprfinfo" items="${schememaster}" varStatus="status">
												<tr>
												<td>
												<input type="hidden" value="${viewprfinfo.excp_id}"></input>
															<%=j%>
													</td>
			...
			<div class="wizard-actions">
											<input type="button" class="btn btn-primary" id="action1" style="margin-top:3%;"  value="Clear Exceptions" onclick="submitform()">
										</div>
									</div>
...
<script type="text/javascript">
	function submitform()
	{
		if (confirm('Are you sure you want to clear exceptions?')) {
			window.location.href="clearRewardExceptions";
		} else {
		    // Do nothing!
		}	
	}
