                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline" style="padding-left: 1em;">
                                                    <h4 style="color: white;">Scheme Approval</h4>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb" style="padding-right: 1em;">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Scheme Approval</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
		...
		<div class="card-block">
			<div class="dt-responsive table-responsive">
				<table id="header-footer-fix"
					class="table table-striped table-bordered nowrap" style="line-height: 0">
					<thead>
						<tr>
					...
					<c:forEach var="viewprfinfo" items="${schememaster}" varStatus="status">
								<tr>
										...
										<td><a href="pendingschemeaprdetails?scheme_id=${viewprfinfo.scheme_id}">${viewprfinfo.scheme_name}</a></td>
