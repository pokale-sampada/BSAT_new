...
<!-- <section role="main" class="content-body">
	...
	<form action="addnewrule" method="post" ModelAttribute="Bpil_Rule_Library" enctype="multipart/form-data">
		...
		<div class="form-group row">
									<div class="col-md-3">
										<label class="block" for="inputSuccess">Rule Name<span
                                            class="required">*</span></label> <input
											type="text" name="rule_name" id="rule_name"
											class="form-control form-control-sm" placeholder="Rule Name"
											required="required">
									</div>
			<!-- <div class="panel-body">
				<div class="col-md-12">
					...
					<div class="col-md-3">
										<label class="block" for="inputSuccess">Description<span
                                            class="required">*</span></label> <input
				...
				<!-- <div class="col-md-4">
					...
					<div class="col-md-3">
						<label class="block" for="inputSuccess">Upload
