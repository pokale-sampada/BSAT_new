        ...
        <script type="text/javascript">
        	...
        	<!-- Add loading content -->
						...
						<div id="loading" style="width:200%;height:230%;margin-left:2%;">
	  								...
	  								<img src="resources/static/img/Loading1.jpg" alt="BASS" style="width:15%;height:15%;margin-left: 18%;margin-top: 0%;" class=""/>
...
<!--                     </div> -->
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="widget-box" style="width: 90%; margin-left: 5%;">
                                <div class="widget-header widget-header-black widget-header">
                                    <h4 class="widget-title lighter"> All Available Documents</h4>
        ...
        <form action="docs" class="form-horizontal" ModelAttribute="New_Scheme_mstr"  id="doc" method="Post" enctype="multipart/form-data">
    ...
    <div class="table-header white" style="margin-top:30px;background-color: #317ece">All Document Details  </div>
