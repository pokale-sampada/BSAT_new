...
<!-- page specific plugin styles -->
        <link rel="stylesheet" href="<c:url value='/resources/assets/css/bootstrap-duallistbox.min.css' />" />
        <link rel="stylesheet"href="<c:url value='/resources/assets/css/bootstrap-multiselect.min.css' />" />
        <link rel="stylesheet" href="<c:url value='/resources/assets/css/select2.min.css' />" />
...
<!--[if lte IE 8]>
	...
	<!-- Add loading content -->
						...
						<div id="loading" style="width:200%;height:230%;margin-left:2%;">
	  								...
	  								<img src="resources/login_assets/Loading1.gif" alt="BASS" style="width:15%;height:15%;margin-left: 16%;margin-top: 0%;" class=""/>
      
    	   							<h6 style="margin-left:20%;"> Loading, Please Wait.....</h6>
						</div>

<body class="no-skin hidecontent" >
...
<!--                     </div> -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="widget-box" style="width: 90%; margin-left: 5%;">
                                <div class="widget-header widget-header-black widget-header">
                                    <h4 class="widget-title lighter"> All Logs</h4>
        ...
        <form action="logs" class="form-horizontal" ModelAttribute="New_Scheme_mstr"  id="logs" method="Post" enctype="multipart/form-data">
    ...
    <div class="table-header white" style="margin-top:30px;background-color: #317ece">Logs Details  </div>

<div>
                             <input type="hidden" id="rowcount1"name="rowcount1" value="">

                             <table class="table table-striped table-bordered table-hover"
                                 id="" cellspacing="0" width="100%">

                                 <thead>
                                     <tr>
<!--                                          <th class="center" style="width:5px;">SR No</th> -->
         ...
         <%int i=1; %>
                     <c:forEach var="grp_reg" items="${logs}" varStatus="status">

                 <tr>
<%--                  <td> <%=i%>    </td> --%>

                 <td>${grp_reg.sch_audit_trail}  </td>
...
<![endif]-->
    ...
    <script
        ...
        type="text/javascript"></script>
    <script
        src="<c:url value='/resources/assets/js/chosen.jquery.min.js'/>"
        type="text/javascript"></script>
    <script
    ...
    <script
        ...
        type="text/javascript"></script>
    <script
        src="<c:url value='/resources/assets/js/bootstrap-tag.min.js'/>"
        type="text/javascript"></script>
    <!-- ace scripts -->
    ...
    <script src="<c:url value='/resources/assets/js/ace.min.js'/>"
        ...
        <!-- page specific plugin scripts -->
      <script src="<c:url value='/resources/assets/js/jquery.raty.min.js'/>" type="text/javascript"></script>
     
       <script src="<c:url value='/resources/assets/js/typeahead.jquery.min.js'/>" type="text/javascript"></script>

<script src="<c:url value='/resources/assets/js/bootstrap-multiselect.min.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resources/assets/js/select2.min.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resources/assets/js/jquery.bootstrap-duallistbox.min.js'/>" type="text/javascript"></script>
