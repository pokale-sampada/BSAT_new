...
<!--forms-wizard css-->
<link rel="stylesheet" type="text/css"
	href="files\bower_components\jquery.steps\css\jquery.steps.css">

<!-- Chartlist chart css -->
<link rel="stylesheet"
	href="files\bower_components\chartist\css\chartist.css"
...
<!-- Date-Dropper css -->
<link rel="stylesheet" type="text/css"
	href="files\bower_components\datedropper\css\datedropper.min.css">

<!-- Switch component css -->
<link rel="stylesheet" type="text/css"
	href="files\bower_components\switchery\css\switchery.min.css">
...
<body>
	...
	<!-- Chart js -->
	<script type="text/javascript"
		src="files\bower_components\chart.js\js\Chart.js"></script>
	<!-- google chart -->
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="files\assets\pages\chart\google\js\custom-google-chart.js"></script>
	<script src="files\assets\js\pcoded.min.js"></script>
	<script type="text/javascript"
		src="files\assets\pages\dashboard\custom-dashboard.js"></script>
	<script type="text/javascript"
		src="files\assets\pages\dashboard\analytic-dashboard.min.js"></script>
	<script type="text/javascript" src="files\assets\js\script.min.js"></script>
	<script src="files\assets\pages\data-table\js\data-table-custom.js"></script>
	<script
		src="files\assets\pages\data-table\extensions\fixed-header\js\fixed-header-custom.js"></script>
	<script type="text/javascript" src="files\assets\js\script.js"></script>
	<script src="files\assets\pages\chart\morris\morris-custom-chart.js"></script>
	<script type="text/javascript"
		src="files\assets\pages\advance-elements\custom-picker.js"></script>
	<script type="text/javascript"
		src="files\assets\pages\chart\echarts\echart-custom.js"></script>
	<script type="text/javascript"
		src="files\assets\pages\advance-elements\swithces.js"></script>
	...
	<script
		src="files\assets\pages\data-table\extensions\fixed-header\js\dataTables.fixedHeader.min.js"></script>
	<script
		src="files\assets\pages\data-table\extensions\colreorder\js\dataTables.colReorder.min.js"></script>
	<script
...
<script
	...
	<!--Forms - Wizard js-->
	<script
		src="files\bower_components\jquery.cookie\js\jquery.cookie.js"></script>
	<script src="files\bower_components\jquery.steps\js\jquery.steps.js"></script>
	<script
		src="files\bower_components\jquery-validation\js\jquery.validate.js"></script>

	<!-- Chartlist charts -->
	<script src="files\bower_components\chartist\js\chartist.js"></script>
	<script
		src="files\assets\pages\chart\chartlist\js\chartist-plugin-threshold.js"></script>
	...
	<script src="../files/assets/pages/chart/echarts/js/chord.js"
		type="text/javascript"></script>

	<!-- Switch component js -->
	<script type="text/javascript"
		src="files\bower_components\switchery\js\switchery.min.js"></script>

	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13"></script>
	<script src="files\bower_components\duallistbox\jquery.bootstrap-duallistbox.js"></script>
    <script src="files\bower_components\duallistbox\jquery.bootstrap.wizard.js"></script>
	...
	$(document).ready(function() {
	    ...
	    function drawChartExploading() {
	        var dataExploading = google.visualization.arrayToDataTable([
	            ['Scheme Request', 'Speakers (in millions)'],
	            ['Incomplete', ${incomplete}],
	            ['Approval Pending', ${approvalpending}],
	            ['Requested To IT', ${requested}],
	            ['Ready To Launch', ${launch}],
	            ['Active', ${active}],
	            ['Inactive Prior Redemption', ${redemptionReady}],
	            ['Inactive Post Redemption', ${processed}],
	            ['Freezed', ${freezed}],
	            ['Closed', ${closed}]
	        ]);
