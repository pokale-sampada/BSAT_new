				...
				<div id="wizard">
					<section>
						<form class="wizard-form" id="example-advanced-form"
							action="new_savescheme_request" ModelAttribute="New_Scheme_mstr"
							...
							<fieldset>
								...
								<div class="form-group row">
									<!-- ------------ Fourth Row -----------  -->
									<div class="col-md-3">
										<label class="block" for="inputDefault"> EffectiveDate From
									...
									<div class="col-md-3">
										<label class="block" >Company Type<span class="required">*</span></label>
							...
							<fieldset>
								...
								<div class="col-md-1">
									...
									<div class="col-md-5">
										<label class="block">Distributor <i
											class="menu-icon fa red"> *</i>
										</label>
										<div>
...
$(window).load(function(){
    ...
    $.ajax({
		...
		url : '${pageContext.request.contextPath}/getcrmcompanyname',
		success : function(data) {

			var select = $('#company_type');
			select.find('option').remove();
			$('<option>').val("").text("--Select--").appendTo(select);
			$.each(data, function(index, value) {
				
				 $('<option>').val(value.company_name).text(value.company_name).appendTo(select);
			});
