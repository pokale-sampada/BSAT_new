	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal form-field" role="form" id="newbranch"
				action="save_Branch" @ModelAttribute="Bpil_Branch_Master">
				<c:forEach var="viewprfinfo" items="${list}"
											varStatus="status">
				<input type="hidden" id="branch_id" name="branch_id" value="${viewprfinfo.branch_id}" />
			   <div class="row">
			   <c:forEach var="brm_region" items="${brm}"
													varStatus="status">
				<div class="col-md-3">
					...
					<select data-plugin-selectTwo
									...
									required>
									<option selected="selected" value="${brm_region.region_id}">${brm_region.region_name}</option>
								</select>
				</div></c:forEach>
				<div class="col-md-3">
					<label class="control-label formmodifiedLable" for="inputDefault">Branch
						Code<span class="required">*</span></label> <input type="text" class="form-control" id="branch_code" name="branch_code" value="${viewprfinfo.branch_code}" required>
				</div>
				<div class="col-md-3">
					<label class="control-label formmodifiedLable" for="inputDefault">Branch
						Name<span class="required">*</span></label> <input type="text" class="form-control" id="branch_desc" name="branch_desc" value="${viewprfinfo.branch_desc}" required>
				</div>
				<div class="col-md-3">
