...
<!-- Basic -->
<meta charset="UTF-8">
<title>BSAT Scheme Creation By OMFYS</title>
						...
						<section class="body-error error-inside">
							<div class="center-error">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<h4 class="text">Try one of the following:</h4>
										<ul class="nav nav-list primary">
											<li>
												<a href="#"><i class="fa fa-caret-right text-dark"></i> Re-check the url for typos</a>
											</li>
											<li>
												<a href="#"><i class="fa fa-caret-right text-dark"></i> Read the faq</a>
											</li>
											<li>
												<a href="#"><i class="fa fa-caret-right text-dark"></i> Tell us about it</a>
											</li>
										</ul>
									</div>
								</div>
