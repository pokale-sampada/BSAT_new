...
public class OPABatchSchemeAnalysisTrigger5 implements Runnable {
	...
	public OPABatchSchemeAnalysisTrigger5(TilesConfiguration hibernateConfiguration,
	...
	public void run() {
		...
		LYSD = cal.getTime();
		System.out.println("enter in thread OPABatchSchemeAnalysisTrigger5");
...
//				System.out.println("calling BPIL_GET_SCH_AN_FLAG2");
				CallableStatement cStmt = connection.prepareCall("{call BPIL_GET_SCH_AN_FLAG5(?)}");
...
//				System.out.println("BPIL_GET_SCH_AN_FLAG2 =" +flag);
				...
				if (flag.equals("Y")) {
					...
					ArrayList<Bpil_BatSchAnalysis_Process_Queue5> rewprocessqueue = (ArrayList<Bpil_BatSchAnalysis_Process_Queue5>) hibernateTemplate
							.find("from Bpil_BatSchAnalysis_Process_Queue5 where status='Pending' order by scheme_id asc");

					System.out.println("Pending Bpil_BatSchAnalysis_Process_Queue5 = " + rewprocessqueue.size());

					for (Bpil_BatSchAnalysis_Process_Queue5 bpil_Process_Queue : rewprocessqueue) {
						...
						String updateschstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE5 "
						...
						if (checkoutputflag.equals("Y")) {
							...
							String updatespstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE5 "
							...
							System.out.println("calling BPIL_SCH_AN_INPUT_ENTRY5");
							CallableStatement getschinputStmt = connection.prepareCall("{call BPIL_SCH_AN_INPUT_ENTRY5(?,?,?)}");
							...
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY5 flag =" + getschinputflag);
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY5 exp =" + getschinputexp);
							...
							String updatespendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE5 "
...
//												}
											...
											compInvalStmt.setString(1, "BPIL_SCH_AN_INPUT_ENTRY5");
...
//											schrwsortStmt.close();
											...
											String updateschendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE5 "
