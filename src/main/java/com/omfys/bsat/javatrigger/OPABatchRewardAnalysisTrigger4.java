...
public class OPABatchRewardAnalysisTrigger4 implements Runnable {
	...
	public OPABatchRewardAnalysisTrigger4(TilesConfiguration hibernateConfiguration, 
	...
	public void run() {
		...
		LYSD = cal.getTime();
		System.out.println("enter in thread OPABatchRewardAnalysisTrigger4");
...
//				System.out.println("calling BPIL_GET_RW_AN_FLAG2");
				CallableStatement cStmt = connection.prepareCall("{call BPIL_GET_RW_AN_FLAG4(?)}");
				cStmt.registerOutParameter(1, Types.VARCHAR);
				
				ResultSet result = cStmt.executeQuery();
				String flag = cStmt.getString(1);
//				System.out.println("BPIL_GET_RW_AN_FLAG2 =" +flag);
				
				cStmt.close();
				if (flag.equals("Y")) {

					ArrayList<Bpil_BatRwAnalysis_Process_Queue4> rwprocessqueue = (ArrayList<Bpil_BatRwAnalysis_Process_Queue4>) hibernateTemplate
							.find("from Bpil_BatRwAnalysis_Process_Queue4 where status='Pending' order by scheme_id asc");

					System.out.println("Pending Bpil_BatRwAnalysis_Process_Queue4 = " + rwprocessqueue.size());

					for (Bpil_BatRwAnalysis_Process_Queue4 bpil_Process_Queue : rwprocessqueue) {
						...
						String updateschstartquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE4 "
						...
						if (checkoutputflag.equals("Y")) {
							...
							String updatespstartquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE4 "
							...
							System.out.println("calling BPIL_OPA_RW_AN_INPUT_ENTRY4");
							CallableStatement getschinputStmt = connection.prepareCall("{call BPIL_OPA_RW_AN_INPUT_ENTRY4(?,?,?)}");
							...
							System.out.println("BPIL_RW_AN_INPUT_ENTRY4 flag =" + getschinputflag);
							System.out.println("BPIL_RW_AN_INPUT_ENTRY4 exp =" + getschinputexp);
							...
							String updatespendquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE4 "
...
//												}
											...
											compInvalStmt.setString(1, "BPIL_OPA_RW_AN_INPUT_ENTRY4");
...
//											rwsortStmt.close();
											...
											System.out.println("calling BPIL_UPDATE_RW_AN_QUEUE4");
											CallableStatement rwq2updateStmt = connection.prepareCall("{call BPIL_UPDATE_RW_AN_QUEUE4(?,?)}");
											rwq2updateStmt.setInt(1, scheme_id);
											rwq2updateStmt.setInt(2, bpil_Process_Queue.getRw_analysis_queue_id());
										
											System.out.println("update process " + scheme_id + " " + bpil_Process_Queue.getRw_analysis_queue_id());
											ResultSet resultrwq2updateStmt = rwq2updateStmt.executeQuery();
											System.out.println("update BPIL_UPDATE_RW_AN_QUEUE4");
										 
											rwq2updateStmt.close();
											
											Date endDate = new Date();
											String endtime = formatter.format(endDate);
											 
											Statement statementschend = connection.createStatement();
											String updateschendquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE4 "
