...
public class OPABatchSchemeAnalysisTrigger3 implements Runnable {
	...
	public OPABatchSchemeAnalysisTrigger3(TilesConfiguration hibernateConfiguration,
	...
	public void run() {
		...
		LYSD = cal.getTime();
		System.out.println("enter in thread OPABatchSchemeAnalysisTrigger3");
...
//				System.out.println("calling BPIL_GET_SCH_AN_FLAG2");
				CallableStatement cStmt = connection.prepareCall("{call BPIL_GET_SCH_AN_FLAG3(?)}");
...
//				System.out.println("BPIL_GET_SCH_AN_FLAG2 =" +flag);
				...
				if (flag.equals("Y")) {
					...
					ArrayList<Bpil_BatSchAnalysis_Process_Queue3> rewprocessqueue = (ArrayList<Bpil_BatSchAnalysis_Process_Queue3>) hibernateTemplate
							.find("from Bpil_BatSchAnalysis_Process_Queue3 where status='Pending' order by scheme_id asc");

					System.out.println("Pending Bpil_BatSchAnalysis_Process_Queue3 = " + rewprocessqueue.size());

					for (Bpil_BatSchAnalysis_Process_Queue3 bpil_Process_Queue : rewprocessqueue) {
						...
						String updateschstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE3 "
						...
						if (checkoutputflag.equals("Y")) {
							...
							String updatespstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE3 "
							...
							System.out.println("calling BPIL_SCH_AN_INPUT_ENTRY3");
							CallableStatement getschinputStmt = connection.prepareCall("{call BPIL_SCH_AN_INPUT_ENTRY3(?,?,?)}");
							...
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY3 flag =" + getschinputflag);
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY3 exp =" + getschinputexp);
							...
							String updatespendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE3 "
...
//												}
											...
											compInvalStmt.setString(1, "BPIL_SCH_AN_INPUT_ENTRY3");
...
//											schrwsortStmt.close();
											...
											String updateschendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE3 "
