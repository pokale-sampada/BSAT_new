...
public class OPABatchRewardAnalysisTrigger2 implements Runnable {
	...
	public OPABatchRewardAnalysisTrigger2(TilesConfiguration hibernateConfiguration, 
	...
	public void run() {
		...
		LYSD = cal.getTime();
		System.out.println("enter in thread OPABatchRewardAnalysisTrigger2");
...
//				System.out.println("calling BPIL_GET_RW_AN_FLAG2");
				CallableStatement cStmt = connection.prepareCall("{call BPIL_GET_RW_AN_FLAG2(?)}");
...
//				System.out.println("BPIL_GET_RW_AN_FLAG2 =" +flag);
				...
				if (flag.equals("Y")) {
					...
					ArrayList<Bpil_BatRwAnalysis_Process_Queue2> rwprocessqueue = (ArrayList<Bpil_BatRwAnalysis_Process_Queue2>) hibernateTemplate
							.find("from Bpil_BatRwAnalysis_Process_Queue2 where status='Pending' order by scheme_id asc");

					System.out.println("Pending Bpil_BatRwAnalysis_Process_Queue2 = " + rwprocessqueue.size());

					for (Bpil_BatRwAnalysis_Process_Queue2 bpil_Process_Queue : rwprocessqueue) {
						...
						String updateschstartquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE2 "
						...
						if (checkoutputflag.equals("Y")) {
							...
							String updatespstartquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE2 "
							...
							System.out.println("calling BPIL_OPA_RW_AN_INPUT_ENTRY2");
							CallableStatement getschinputStmt = connection.prepareCall("{call BPIL_OPA_RW_AN_INPUT_ENTRY2(?,?,?)}");
							...
							System.out.println("BPIL_RW_AN_INPUT_ENTRY2 flag =" + getschinputflag);
							System.out.println("BPIL_RW_AN_INPUT_ENTRY2 exp =" + getschinputexp);
							...
							String updatespendquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE2 "
...
//												}
											...
											compInvalStmt.setString(1, "BPIL_OPA_RW_AN_INPUT_ENTRY2");
...
//											rwsortStmt.close();
											...
											System.out.println("calling BPIL_UPDATE_RW_AN_QUEUE2");
											CallableStatement rwq2updateStmt = connection.prepareCall("{call BPIL_UPDATE_RW_AN_QUEUE2(?,?)}");
											...
											System.out.println("update BPIL_UPDATE_RW_AN_QUEUE2");
											...
											String updateschendquery = "UPDATE BPIL_RW_ANALYSIS_QUEUE2 "
