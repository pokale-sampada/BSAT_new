...
public class OPABatchSchemeAnalysisTrigger2 implements Runnable {
	...
	public OPABatchSchemeAnalysisTrigger2(TilesConfiguration hibernateConfiguration,
	...
	public void run() {
		...
		LYSD = cal.getTime();
		System.out.println("enter in thread OPABatchSchemeAnalysisTrigger2");
...
//				System.out.println("calling BPIL_GET_SCH_AN_FLAG2");
				CallableStatement cStmt = connection.prepareCall("{call BPIL_GET_SCH_AN_FLAG2(?)}");
...
//				System.out.println("BPIL_GET_SCH_AN_FLAG2 =" +flag);
				...
				if (flag.equals("Y")) {
					...
					ArrayList<Bpil_BatSchAnalysis_Process_Queue2> rewprocessqueue = (ArrayList<Bpil_BatSchAnalysis_Process_Queue2>) hibernateTemplate
							.find("from Bpil_BatSchAnalysis_Process_Queue2 where status='Pending' order by scheme_id asc");

					System.out.println("Pending Bpil_BatSchAnalysis_Process_Queue2 = " + rewprocessqueue.size());

					for (Bpil_BatSchAnalysis_Process_Queue2 bpil_Process_Queue : rewprocessqueue) {
						...
						String updateschstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE2 "
						...
						if (checkoutputflag.equals("Y")) {
							...
							String updatespstartquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE2 "
							...
							System.out.println("calling BPIL_SCH_AN_INPUT_ENTRY2");
							CallableStatement getschinputStmt = connection.prepareCall("{call BPIL_SCH_AN_INPUT_ENTRY2(?,?,?)}");
							...
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY2 flag =" + getschinputflag);
							System.out.println("BPIL_SCH_AN_INPUT_ENTRY2 exp =" + getschinputexp);
							...
							String updatespendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE2 "
...
//												}
											...
											compInvalStmt.setString(1, "BPIL_SCH_AN_INPUT_ENTRY2");
...
//											schrwsortStmt.close();
											...
											String updateschendquery = "UPDATE BPIL_SCH_ANALYSIS_QUEUE2 "
