...
@Data
@Entity
@Table(name = "BPIL_OPA_SCH_ANALYSIS_RW")
public class Bpil_Opa_Sch_Analysis_Rw {
	
	@Id
	@Column(name = "OPA_SCH_AN_REWARD_ID")
	...
	@Column(name = "REWARD_ADJUSTED_BY")
	private String reward_adjusted_by;
	...
	//parameters for Scheme Analysis Report
	@Transient
	private String ml;
	@Transient
