...
@Data
@Entity
@Table(name = "BPIL_MENU_LINES")
public class Bpil_Menu_Line implements Serializable{
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "course_seq")
	@SequenceGenerator(name = "course_seq", sequenceName = "BPIL_MENU_LINES_S", allocationSize = 1)
	...
	private Date line_start_date= new java.sql.Date(new java.util.Date().getTime());
	
	@DateTimeFormat(pattern = "dd/mm/yyyy")
	@Column(name = "LINE_END_DATE")
	private Date line_end_date= new java.sql.Date(new java.util.Date().getTime());	
