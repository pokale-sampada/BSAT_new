...
(function(d) {
    ...
    d.extend(i.prototype, {
        ...
        _unsize: function(b) {
            ...
            wt = $(".table").outerWidth()
            a && ("footer" === b || ("header" === b && !this.s.autoWidth)) ? d("th, td", a).css({ width: wt, minWidth: "" }) : a && "header" === b && d("th, td", a).css("min-width", "");
        },
        _horizontal: function(b, a) {
            ...
            console.log("c.left - a", c.left - a)
            console.log("c.left", c.left)
            lt = $(".table").offset().left

            e.floating && d[b] !== a && (e.floating.css("left", lt), (d[b] = a));
        },
        _modeChange: function(b, a, e) {
            ...
            "in" === b ?
                ...
                console.log($("fix-header").scrollTop(), "fix-header")
            "below" === b ?
                (this._clone(a, e),
                    c.floating
        ...
        _positions: function() {
            ...
            console.log("b.outerWidth();", b.outerWidth())
            a.left = b.offset().left;
            console.log("b.offset().left", b.offset().left)

            a.theadTop = c.offset().top;
            console.log("c.offset().top", c.offset().top)
    ...
    i.version = "3.1.2";
    i.defaults = { header: !0, footer: !1, headerOffset: 56, footerOffset: 0 };
